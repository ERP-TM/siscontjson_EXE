...
def export_table_to_json(
    ...
    table_query,
    save: bool = True,
    field_cleaners: Optional[Dict[str, Callable[[Any], Any]]] = None,
) -> list:
    try:
        ...
        # Aplicar limpieza de datos si se especificaron cleaners
        if field_cleaners:
            from utils.data_cleaners import apply_field_cleaners

            result = apply_field_cleaners(result, field_cleaners)
...
def export_table_to_json_paginated(
    ...
    try:
        ...
        if field_cleaners:
            ...
            all_results = apply_field_cleaners(all_results, field_cleaners)
